...
# Create a larger ticking area that covers all NPCs including yrsaNPC and idrisquestNPC
# Expanded to cover yrsaNPC (-40277 -10 -40004) and idrisquestNPC (-40342 -10 -39878)
# Using a rectangular area from -40450 to -40250 (X), -40050 to -39850 (Z)
